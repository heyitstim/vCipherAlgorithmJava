...
public class Hellodarknessmyoldfriend {
    ...
    static void menu(){
        ...
        switch(choice){
            case 1:
                ...
                if(passphrase.isEmpty() || passphrase.isBlank()){
                    System.out.println("Please input passphrase");
                }
                vcipher_encryption(passphrase);
                //test A198711bczx2u or ghAl99Ebn83hzx4iU
                //test encryption rxzcbv or 
                break;
            case 2:
                System.out.print("\033[H\033[2J"); //clear screen 40-41
                System.out.flush();
    ...
    public static void vcipher_decryption(String passphrase){
        ...
        rev.append(passphrase); //reverse passphrase line 55-56
        rev = rev.reverse(); //rev == reversed passphrase
        int passphrase_length = rev.length();
    ...
    public static void vcipher_encryption(String passphrase){ //needs to be fixed
        ...
        int passphrase_length = passphrase.length();
        String rand_num = "0123456789";
        
        char rand_num_final = rand_num.charAt(ran.nextInt(rand_num.length()));
        System.out.println(rand_num_final); 
        
        if(passphrase_length % 2 == 1){
            ...
            char finalszx = rev_final.charAt(ran.nextInt(rev_final.length()));
            rev.append(finalszx);
